...
public class LoanControllerTest {
    ...
    @DisplayName("Test get loan info by customer id 1 should return loan infomation")
    @Test
    void testGetLoanInfoByIdEquals1() throws Exception {
        ...
        assertEquals("x02-222-2200", data.get("account_payable").toString());
        assertEquals("x02-222-2200", data.get("account_receivable").toString());
        assertEquals(3000000, data.get("principal_amount"));

        verify(loanService, times(1)).getLoanInfoById(reqParam);
    }
    @DisplayName("Test get loan info by customer id 2 should return thrown exception")
    @Test
    ...
    @DisplayName("Test get loan info by customer id 3 should return thrown")
    @Test
